...
const MidDetails = () => {
  return (
    <div className="flex flex-col w-[842px] mx-auto">
      <div className="w-full flex flex-col  mt-12">
        <div className="">
          <h2 className="text-[#263238] text-[24px] font-bold dark:text-gray-200">
            چگونه آموزش ببینیم
          </h2>
          <p className="mt-3 font-normal tracking-[-0.01em] text-[#455A64] dark:text-gray-400">
          ...
          <div className="flex   mt-3 text-[#455A64] dark:text-gray-400 ">
            ...
            <p>
              ...
              ممکن است احساس افزایش انرژی و کاهش خستگی را در شما به ارمغان
              بیاورد.
            </p>
          </div>
          <div className="flex   mt-3 text-[#455A64] dark:text-gray-400 ">
      ...
      <div className="mt-12 text-[#455A64] dark:text-gray-400 tracking-tight">
        ...
        <p className="mt-4">امیدوارم مقاله مفیدی برای شما واقع بوده باشه.</p>
      </div>
      <div className="w-full bg-[#ECEFF1] dark:bg-[#1C1C1E] flex h-[64px] rounded-2xl justify-between items-center mt-10">
      ...
      <div className="w-full h-[48px] flex justify-between mt-[40px]">
        <div className="flex items-center">
          ...
          <p className="mr-3 text-[#263238] dark:text-gray-200">
            امتیاز 20 نفر
          </p>
          <button className="mr-4 h-[32px]  w-[81px] flex justify-center items-center bg-[#2196F3] dark:bg-[#1565C0] text-white shadow-Second-shadow rounded-[80px] text-[12px]">
            ثبت دیدگاه
          </button>
        </div>

        <div className="flex items-center">
          <p className="ml-6 text-[#455A64] dark:text-gray-400">
            آیا از این مقاله راضی بودید ؟
          </p>
          <div className="items-center flex w-[83px] h-[48px] bg-[#ECEFF1] ml-4 rounded-[50px] dark:bg-[#37474F] ">
            <span className="mr-4">
              <svg
                width="24"
                height="24"
            ...
            <p className="mr-[6px] text-[#263238] dark:text-gray-400">22</p>
          </div>

          <div className="items-center flex w-[83px] h-[48px] bg-[#ECEFF1]  rounded-[50px] dark:bg-[#37474F] ">
            <span className="mr-4">
              <svg
                width="24"
                height="24"
