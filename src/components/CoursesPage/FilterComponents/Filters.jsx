...
const Filters = () => {
  return (
    <>
      <div className="flex min-h-[779px] xl:w-[296px] lg:w-[249px] md:w-[209px]  border rounded-[24px] bg-white dark:bg-gray-900 dark:border-gray-950 shadow-ّFirst-shadow flex-col items-center xl:mr-0 mr-4  ">
        {/* 1Com */}
