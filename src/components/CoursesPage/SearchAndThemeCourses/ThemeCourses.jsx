...
const ThemeCourses = () => {
  ...
  return (
    <div className="sm:w-[100px]  w-full sm:h-full h-[50px] sm:flex hidden bg-[#ECEFF1] dark:bg-[#1C1C1C] justify-center items-center gap-1 rounded-2xl sm:order-none order-1 ">
      <div
