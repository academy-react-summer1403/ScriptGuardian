...
const DetailsLeft = () => {
  return (
    <div className="flex flex-col sm:w-[405px] w-[95%] sm:mt-0 mt-5 ">
      <div className="w-full items-center flex flex-col h-[501px] shadow-ّFirst-shadow bg-white dark:bg-gray-900 rounded-3xl">
        ...
        <div className="border-y-[1px] dark:border-y-gray-950 sm:w-[341px] w-[95%] h-[288px] mt-6 flex flex-col">
          <div className="flex justify-between w-full h-[72px] border-b dark:border-b-gray-950 items-center">
            ...
            <p className="text-[#263238]  dark:text-gray-200 font-bold">27</p>
          </div>
        ...
        <div className="sm:w-[341px] w-[95%] h-[56px] mt-8 flex items-center justify-between">
      ...
      <div className="w-full h-[112px] bg-white dark:bg-gray-900 rounded-3xl mt-8 flex items-center ">
        ...
        <div className="flex flex-col mr-4">
          <div className="flex items-center ">
            ...
            <p className="font-bold text-[#263238] dark:text-gray-200">دکتر</p>
          </div>
