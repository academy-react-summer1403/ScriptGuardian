  ...
  return (
    <div className="flex flex-col w-[405px] ">
      <div className="w-full items-center flex flex-col h-[501px] shadow-ّFirst-shadow bg-white dark:bg-gray-900 rounded-3xl">
        ...
        <div className="border-y-[1px] dark:border-y-gray-950 w-[341px] h-[288px] mt-6 flex flex-col">
        ...
        <div className="w-[341px] h-[56px] mt-8 flex items-center justify-between">
