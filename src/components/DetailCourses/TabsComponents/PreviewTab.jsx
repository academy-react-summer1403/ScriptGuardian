            ...
            <div className="flex flex-col ">
              ...
              >
                <div className="flex items-center mr-3">
                  ...
                  <p className="mr-1 sm:text-base text-xs">
                    {" "}
                    <span className="font-bold"> فصل دوم: </span> Css چیست؟{" "}
                  </p>
                </div>
                <div className="flex items-center ml-5 gap-x-2">
                  <p className="sm:text-base text-xs">{convertEnToPe(56)} دقیقه</p>
            ...
            <div className="flex flex-col ">
              ...
              >
                <div className="flex items-center mr-3">
                  ...
                  <p className="mr-1 sm:text-base text-xs">
                    {" "}
                    <span className="font-bold"> فصل سوم: </span> JavaScript
                    چیست؟{" "}
                  </p>
                </div>
                <div className="flex items-center ml-5 gap-x-2">
            ...
            <div className="flex flex-col ">
              ...
              >
                <div className="flex items-center mr-3">
                  ...
                  <p className="mr-1 sm:text-base text-xs">
                    {" "}
                    <span className="font-bold"> فصل چهارم: </span> React چیست؟{" "}
                  </p>
                </div>
                <div className="flex items-center ml-5 gap-x-2">
                  <p className="sm:text-base text-xs">{convertEnToPe(56)} دقیقه</p>
