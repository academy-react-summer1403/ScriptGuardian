...
const CommentTab = ({ activeTab }) => {
  return (
    <>
      {activeTab === "comments" && (
        <div className="xl:w-[779px]  w-full  flex flex-col items-center ">
          <Formik>
          ...
          <div className="xl:w-[778px] w-full mt-[24px] flex flex-col">
            ...
            {/* Replay */}
            <div className="xl:w-[722px]  w-[92%]   flex  flex-col sm:mr-[31px] mr-3 mt-6 border-r  border-[#CFD8DC] dark:border-[#B0BEC5] ">
