...
const CommentTab = ({ activeTab }) => {
  return (
    <>
      {activeTab === "comments" && (
        <div className="w-[779px]   flex flex-col items-center ">
          <Formik>
            <Form className="w-full flex justify-center  flex-col">
              <textarea
                className="w-[779px] h-[100px] pt-3 pr-3 border rounded-[10px] mx-auto  dark:border-gray-950 dark:bg-slate-900  outline-none dark:caret-white"
          ...
          <div className="w-[778px] h-[570px] mt-[24px] flex flex-col">
            ...
            <div className="w-full  min-h-[92px] flex  flex-col mt-6 ">
              <div className="flex justify-between items-center w-full">
                ...
                <p className="dark:text-[#1565C0] text-[#2196F3] text-sm">
                  مشاهده 12 نظر دیگر
                </p>
                <p className="text-xs text-[#607D8B] dark:text-gray-400">
                  2 روز پیش
