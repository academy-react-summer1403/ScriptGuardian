...
const CommentTab = ({ activeTab }) => {
  return (
    <>
      {activeTab === "comments" && (
        <div className="sm:w-[779px] h w-full  flex flex-col items-center ">
          <Formik>
            <Form className="w-full flex justify-center  flex-col">
              <textarea
                className="sm:w-[779px] w-full h-[100px] pt-3 pr-3 border rounded-[10px] mx-auto  dark:border-gray-950 dark:bg-slate-900  outline-none dark:caret-white sm:placeholder:text-base placeholder:text-xs"
          ...
          <div className="sm:w-[778px] w-full mt-[24px] flex flex-col">
            {/* Comment */}
            ...
            {/* Replay */}
            <div className="sm:w-[722px]  w-[92%]   flex  flex-col sm:mr-[31px] mr-3 mt-6 border-r  border-[#CFD8DC] dark:border-[#B0BEC5] ">
