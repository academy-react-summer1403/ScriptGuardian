  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center ">
        ...
        {/* UserInform */}
        <div className="flex border-purple-800 py-3 rounded-xl mt-5 w-[95%]  border flex-col relative  ">
          <div className="flex lg:mr-[5%]  mt-3 md:flex-nowrap flex-wrap md:flex-row flex-col md:flex-start items-center lg:gap-x-0 md:gap-x-[10%] md:gap-y-0 gap-y-3 ">
            <div className="flex items-center md:w-[200px] lg:mr-0 md:mr-3 ">
              ...
              <p className="text-purple-900">فلان فلانی</p>
            </div>

            <div className="flex items-center w-auto lg:mr-[10%]">
              <p>تاریخ تولد</p>
              <p className="text-purple-900"> 1385/05/08</p>
            </div>

            <div className="flex items-center w-auto lg:mr-[28%]">
              <p>شماره همراه</p>
              <p className="text-purple-900"> 90111111111</p>
            </div>
          </div>
          ...
          <div className="flex mt-3 lg:mr-[5%] md:mb-5 mb-12 md:flex-nowrap flex-wrap md:flex-row flex-col md:items-start items-center md:gap-y-0 gap-y-3  ">
            <div className="flex items-center w-auto justify-center lg:mr-0 md:mr-3">
              <p>شماره ملی</p>
              <p className="text-purple-900 "> 2242242244</p>
            </div>

            <div className="flex items-center lg:mr-[15.5%] md:mr-[17%]">
              <p> ایمیل</p>
              <p className="text-purple-900"> TestEmail@gmail.com</p>
            </div>
          </div>

          <Link
            to={"/panel/MyProfile"}
            className="absolute bottom-0 left-0 w-[100px] flex items-center justify-center h-[44px] rounded-t-xl border-t border-r  border-black  text-sm"
          >
            ویرایش
          </Link>
        </div>
        ...
        <div className="flex sm:flex-row flex-col w-[95%] mt-10 gap-x-10 ">
          ...
          <div className="flex flex-col sm:w-[47.5%] ">
            <div className="flex items-center text-xl gap-x-1 ">
              {" "}
              <FaMinus className="text-xl text-purple-600" />
              <h3 className="text-[#263238] font-bold"> اخرین دوره ثبت شده</h3>
            </div>

            <div className="flex flex-col w-full mt-5 gap-y-5 ">
              {/* Items */}
              <div className="flex w-full bg-white rounded-md h-[75px] shadow-ّFirst-shadow  items-center ">
                ...
                <div className="flex w-[100%] h-[85%] flex-col justify-between ">
                  <h3 className="mr-3 text-[#263238]">
                    آموزش رایگان اچ تی ام ال
                  </h3>
                  <div className="flex justify-between text-[#455A64] items-center mr-3">
                    <p className="text-sm">دکتر بحر</p>

                    <p className="text-sm ml-3">
                      <span className="text-purple-700">500,000</span> تومان
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col sm:w-[47.5%] sm:mt-0 mt-5 mb-5">
            <div className="flex items-center text-xl gap-x-1 ">
              {" "}
              <FaMinus className="text-xl text-purple-600" />
              <h3 className="text-[#263238] font-bold"> دوره های پیشنهادی</h3>
            </div>
